...
- A required 4-digit PIN setup step when adding a Duo device.
- PIN verification before approving Duo requests for a device.
- PIN verification before SSH host connect actions, including Auto-Approve connect flows.

## 0.4.0

### Added

- A dedicated Connect action row under each host in the Hosts view.
