...
[![VS Code Marketplace](https://vsmarketplacebadges.dev/version-short/thisisamirv.vsduo-auth.png)](https://marketplace.visualstudio.com/items?itemName=thisisamirv.vsduo-auth)
